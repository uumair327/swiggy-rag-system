...
def create_rag_system(
    ...
    try:
        ...
        logger.info(f"Creating SentenceTransformer adapter with model: {config.embedding_model_name}")
    ...
    try:
        ...
        document_processor = DocumentProcessor(
            document_loader_port=document_loader
        )
        ...
        embedding_generator = EmbeddingGenerator(
            embedding_model_port=embedding_model
        )
