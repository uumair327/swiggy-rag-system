...
5. Be concise and accurate"""
    ...
    def generate_answer(self, question: str, context: List[RetrievedChunk]) -> Answer:
        """
        ...
        if not context:
            ...
            return Answer(
                text=self.NOT_FOUND_RESPONSE, supporting_chunks=[], confidence="not_found"
            )
        ...
        if self._is_not_found_response(answer_text):
            ...
            return Answer(text=answer_text, supporting_chunks=context, confidence="not_found")
        ...
        return Answer(text=answer_text, supporting_chunks=context, confidence=confidence)

    def validate_answer_from_context(self, answer: str, context: List[RetrievedChunk]) -> bool:
        """
    ...
    def _determine_confidence(self, context: List[RetrievedChunk], references_context: bool) -> str:
        """
        ...
        avg_similarity = sum(chunk.similarity_score for chunk in context) / len(context)
