...
class TestEmbeddingGeneratorProperties:
    ...
    def test_property_5_embedding_generation_success(self, embedding_model_cached, text):
        ...
        **Validates: Requirements 3.1**
        ...
        assert isinstance(result, Embedding), "generate_embedding should return Embedding instance"
        ...
        assert result.source_text == text, "Embedding source_text should match input text"
    ...
    def test_property_6_batch_embedding_completeness(self, embedding_model_cached, texts):
        ...
        **Validates: Requirements 3.3**
        ...
        assert isinstance(results, list), "generate_embeddings_batch should return a list"
        ...
        for i, result in enumerate(results):
            assert hasattr(result, "vector"), f"Embedding at index {i} should have vector attribute"
            assert result.vector is not None, f"Embedding vector at index {i} should not be None"
            assert isinstance(
                result.vector, np.ndarray
    ...
    def test_property_7_embedding_dimensionality_consistency(self, embedding_model_cached, texts):
        ...
        **Validates: Requirements 3.4, 5.3**
        ...
        assert len(embeddings) > 0, "Should have generated at least one embedding"
